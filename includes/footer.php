        ...
        <section id="navmap" class="clearfix"><br>
            ...
            <!-- Download -->
            <div class="column">
                <img src="../assets/img/qrcode.png" width="135px" alt="QRCode para o download do aplicativo">
                <br><br>
          ...
          Store</button>
            ...
            <div style="color:white;" class="column">
                ...
                <a href="motorista/sobremotoristas.php">Motoristas </a> <br>
                <a href="passageiro/sobrepassageiros.php">Passageiros </a> <br>
