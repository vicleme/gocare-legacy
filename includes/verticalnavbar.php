<?php
    if ( (!empty($_SESSION['passageiro'])) ){
        ...
        include(__DIR__ . "/passageiro/selecionapassageiro.php");
    }
    if ( (!empty($_SESSION['motorista'])) ){
        $usertype = 'motorista';
        $usertypeC = 'Motorista';
        include(__DIR__ . "/motorista/selecionamotorista.php");
    }
...
<div class="vertical-nav" id="sidebar" style="background-color: rgb(26, 57, 129);">
        <div class="py-4 px-3 mb-4" style="background-color: rgb(30, 44, 78);">
            <div class="media d-flex align-items-center"><img src="../assets/img/uploads/<?php echo $campo['fotoperfil']?>" alt="..." width="65" class="mr-3 rounded-circle img-thumbnail shadow-sm">
        ...
        <ul class="nav flex-column mb-0" style="color: white">
            <li class="nav-item" id="abaeditarperfil">
                <a href="../<?php echo $usertype; ?>/perfil<?php echo $usertype;?>.php" class="nav-link" style="color: white;">
                    <i class='fas fa-address-card' style='margin-right:15px'></i>Editar perfil
                </a>
            </li>
            <li class="nav-item" id="abaalterarsenha">
                <a href="../<?php echo $usertype; ?>/perfil<?php echo $usertype;?>editasenha.php" class="nav-link" style="color: white;">
                    <i class='fas fa-key' style='margin-right:15px;'></i>Alterar senha
                </a>
            </li>
            <li class="nav-item" id="abanotificacoes">
                <a href="#" class="nav-link" style="color: white;">
                <!--<a href="../<?php echo $usertype; ?>/notificacoes<?php echo $usertype;?>.php"  class="nav-link" style="color: white;">-->
        ...
        <ul class="nav flex-column mb-0" style="color: white">
            <li class="nav-item" id="abacorridas">
                <a href="../<?php echo $usertype; ?>/corridas<?php echo $usertype;?>.php" class="nav-link" style="color: white;">
