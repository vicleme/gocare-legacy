<section id="navbar">
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#1e47a8;">
        ...
        <a class="navbar-brand" href="index.php">
            <img src="../assets/img/brand-navbar.png" style="width: 112px;" alt="Logotipo da GoCare">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="motorista/sobremotoristas.php">Motoristas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="passageiro/sobrepassageiros.php">Passageiros</a>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <?php echo '<a class="dropdown-item" href="../'.$usertype.'/perfil'.$usertype.'.php">Área do '.$usertypeC.'</a>'; ?>
