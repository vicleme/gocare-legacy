<?php
    ...
    if ( (!empty($_SESSION['motorista'])) || (!empty($_SESSION['passageiro'])) ){
        if (!empty($_SESSION['motorista'])) {
            ...
            header("Location: motorista/perfilmotorista.php");
            exit;
        } else {
            $login = $_SESSION['passageiro'];
            header("Location: passageiro/perfilpassageiro.php");
            exit;
        }
    }
            ...
            <section id="entrarpassageiromotorista">
                <div class="container-fluid" style="width: 80%;margin: 5px auto 35px;">
                    <div class="card-group">
                        ...
                        <div class="card">
                            <img class="card-img-top" src="assets/img/motorista.png" alt="Motorista">
                            <div class="card-body">
                        ...
                        <div class="card">
                            <img class="card-img-top" src="assets/img/passageiro2.png" alt="Passageiro">
                            <div class="card-body">
                                <h5 class="card-title" style="text-align:center"></h5>
                                <p class="card-text">
                                    <p style="text-align:center">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div style="text-align: center;margin:20px 20px 0px 20px">
                    ...
                    <img src="assets/img/favicon.ico" style="width: 12%;">
                    <h2>Venha ser nosso motorista!</h2>
                </div>

                <div class="modal-body">
                    <form action="motorista/cadastramotorista.php" method="post" style="margin: 1% 2%;">
                        <div class="form-row">
    ...
    <div class="modal fade" id="cad-passageiro-modal-lg" tabindex="-1" role="dialog" aria-labelledby="cadpasLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="passageiro/cadastrapassageiro.php" method="post" style="margin: 1% 2%;">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <p>Nome: </p>
                                <label for="nome" class="sr-only">Nome</label>
    ...
    <div class="modal fade" id="login-motorista-modal" tabindex="-1" role="dialog" aria-labelledby="loginmotoLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <!-- Corpo -->
                <div class="modal-body">
                    <form action="motorista/loginmotorista.php" method="post" style="margin: 1% 2%;">
    ...
    <div class="modal fade" id="login-passageiro-modal" tabindex="-1" role="dialog" aria-labelledby="logipasLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <!-- Corpo -->
                <div class="modal-body">
                    <form action="passageiro/loginpassageiro.php" method="post" style="margin: 1% 2%;">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <p>Usuário: </p>
                                <label for="nome" class="sr-only">Usuário:</label>
