...
include(__DIR__ . "/selecionamotorista.php");
...
<head>
    ...
    <link href="../assets/css/vertical-navbar.css" rel="stylesheet">
...
<body style="background-color:rgb(87, 154, 210)">
    ...
    <?php
        include(__DIR__ . '/../includes/verticalnavbar.php');
    ?>
            ...
            <div class="card" style="width: 70%;margin: auto;">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <form action="perfilmotoristaeditaprocessa.php" method="post" enctype="multipart/form-data" style="margin: 1% 2%;">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <img src="../assets/img/uploads/<?php echo $campo['fotoperfil']?>" style="max-width: 182px;width: 80%;background-color: #cacfcd;">
                                    <br><br>
