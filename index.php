...
<body>
    ...
    <section id="presentation2">
        <img style="width: 100%;" src="assets/img/circle1.png">
    </section>

    <!-- Download -->
    <section id="download">
        <img style="width: 100%;" src="assets/img/circle2.png">
        ...
        <div id="mobile" style="text-align:left;position: absolute; left:5vw;top: 10vw;">
            <img src="assets/img/gocaremobile.png" style="width: 32vw;" alt="Ícone mobile do GoCare">
        </div>
        <div id="qrcode" style="text-align:left;position: absolute; left:53vw;top: 21vw;">
            <img src="assets/img/qrcode.png" style="width: 16vw;" alt="QRCode para o download do aplicativo">
        </div>
    ...
    <!-- Parceiros -->
    <section id="partners">
        <img style="width: 100%;" src="assets/img/circle3.png">
        ...
        <div>
            <div class="container-fluid" style="position: relative; left:0vw;top: -4vw;padding-left:0;padding-right:2.5;width: 70%;">
                <div class="card-group">
                    ...
                    <div class="card">
                        <img class="card-img-top" src="assets/img/parceiro1.png" alt="Monalisa">
                        <div class="card-body">
                    ...
                    <div class="card">
                        <img class="card-img-top" src="assets/img/parceiro2.png" alt="Monalisa">
                        <div class="card-body">
                    ...
                    <div class="card">
                        <img class="card-img-top" src="assets/img/parceiro3.png" alt="Monalisa">
                        <div class="card-body">
